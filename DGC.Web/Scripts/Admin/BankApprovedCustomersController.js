var BankApprovedCustomersController = [
    '$scope', '$http', 'subMenuService', 'loginInfoService', function($scope, $http, subMenuService, loginInfoService) {
        ...
        $scope.buildTable = function() {
            var tblURL = "/Administrator/Admin/GetCustomerByStatus?Id=" + $scope.BankId + "&status=UnderReview&bankStatus=Verified";
            ...
            jQuery("#tblBankApprovedCustomerList").kendoGrid({
                selectable: "row",
                ...
                columns: [
                    ...
                    { field: "BankApprovalStatus", title: "Bank Account Verification", width: 160 },
                    {
                        ...
                        template: function(dataItem) {
                            if (dataItem != null) {
                                return "<span><a href=\#/Client/Customer/Details/" + dataItem.Id + "\> <i class='glyphicon glyphicon-edit'></i></a></span>";
                            }
                        }
                    }
                ]
