...
util.DbManager('RequisitionStatusFactory', "/Account/");



var RequisitionStatusController = [
    '$scope', 'RequisitionStatusFactory', '$routeParams', '$location', '$http', '$window', function ($scope, RequisitionFactory, $routeParams, $location, $http, $window) {
        alert('Inside requisition status controller');
